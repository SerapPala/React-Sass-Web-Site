...
const About = () => {
    ...
    const [sections] = React.useState ([
       ...
       </svg>, heading : 'Dijital Market', text: ' Dolore dolor rebum et et ipsum, dolore nonumy sed.' },
       {id: 2, icon: <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-tv" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
     ...
     </svg>, heading: 'Web Geliştirme', text: 'Dolore dolor rebum et et ipsum, dolore nonumy sed.'},
     {id: 3 , icon : <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-layers-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>, heading: 'Grafik Dizayn', text: 'Dolore dolor rebum et et ipsum, dolore nonumy sed.'}
    ]);
    return (
        <div className="about">
